---
title: How to use the Studio API
---

# How to use the Studio API

**NOTE**:
You can use the Studio's REST API to access your projects and machines in any of your external projects. This allows you to automate your workflow, integrate your machines with other projects, and more. Some things you can do with the API include:

- Export machines to your desired language/format (e.g: TS, JS, JSON, etc.)
- Fetch information about your desired machines
- Fetch information about your projects
- Fetch a specific version of a machine
