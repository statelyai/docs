...
Try building your own state machine online using our [visual editor](https://stately.ai/).
If you use our [VS Code extension](https://marketplace.visualstudio.com/items?itemName=statelyai.stately-vscode) you can even use the visual editor inside VS Code.

<a href="https://stately.ai/viz" title="XState Viz">
  <img src="/screenshots/toggle-machine.png" alt="XState Viz" />
</a>
