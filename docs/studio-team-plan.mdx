...
[Upgrade to a Team account](https://stately.ai/pricing) to get features designed to help you collaborate with your team, on any number of projects, including the following team features:

## Team features

- Everything from the [Pro](/docs/studio-pro-plan) plan
- Create one or more teams, based on your needs
- [Private, shared team projects](/projects.mdx#change-a-projects-visibility)
- Add up to 10 team members
- Team admins and editors
- Grant view-only acces to team projects
...
We offer a **7-day free trial** on all of our Stately Studio paid accounts so you can explore how our Team features work for you and your team.
...
If you are a team member of another user’s [team](/teams.mdx), you also have access to [Pro features](#pro-features)! However, if you want to create your own teams, you need to [upgrade to your own Pro or Team subscription](/upgrade.mdx).
