...
Delays are used in XState to represent timers and intervals. We’ll revisit delays in more depth later. [Take a fast track to learn more about delays](../transitions-and-choices/after.mdx).
