...
There are some cases where Stately versions will automatically be created for a machine. These are indicated in the list of versions with the Stately bot icon.
