...
Version history is helpful if you want to save checkpoints while modeling machines or mirror version changes in the rest of your codebase. All users can view versions of public machines. Users on our Pro plan and team members can view and create versions for machines in team projects and their own machines in **My Projects**. [Read more about team roles and versions](#team-roles-and-versions).
...
An initial version is created when a new machine is created or imported. Autosaved machines have a Stately Bot icon. For newer machines, the initial version is named “Initial version.” The initial version’s name for older machines is a timestamp of when the machine was created or imported. Machines created in 2022 may not have an initial version as they were made before the version history existed.
...
<ThemedImage
  ...
  sources={{
    light: useBaseUrl('/versions/version-preview.png'),
    dark: useBaseUrl('/versions/version-preview-dm.png'),
  }}
/>
</p>
...
<ThemedImage
  ...
  sources={{
    light: useBaseUrl('/versions/version-auto.png'),
    dark: useBaseUrl('/versions/version-auto-dm.png'),
  }}
/>
</p>
...
<ThemedImage
  ...
  sources={{
    light: useBaseUrl('/versions/version-restore.png'),
    dark: useBaseUrl('/versions/version-restore-dm.png'),
  }}
/>
</p>
...
<ThemedImage
  ...
  sources={{
    light: useBaseUrl('/versions/version-restore-button.png'),
    dark: useBaseUrl('/versions/version-restore-button-dm.png'),
  }}
/>
</p>
...
<ThemedImage
  ...
  sources={{
    light: useBaseUrl('/versions/version-copy.png'),
    dark: useBaseUrl('/versions/version-copy-dm.png'),
  }}
/>
</p>
...
<ThemedImage
  ...
  sources={{
    light: useBaseUrl('/versions/version-delete.png'),
    dark: useBaseUrl('/versions/version-delete-dm.png'),
  }}
/>
</p>
