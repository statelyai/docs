...
Use the keyboard shortcut **cmd** + **shift** + **S** to save a new version when the **Version history** panel is open.
...
- you import a machine from code
