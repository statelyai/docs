...
<ThemedImage
  ...
  sources={{
    light: useBaseUrl('/states/parent-states/parent-states.png'),
    dark: useBaseUrl('/states/parent-states/parent-states-dm.png'),
  }}
/>
</p>
...
Find out [more about parent and child states in XState](/xstate/states/parent-and-child-states) in the XState section of the docs.
