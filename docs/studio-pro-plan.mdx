...
### Team Member Pro Features

If you are a team member on another user's [team](https://stately.ai/docs/teams), you also have access to [Pro features](https://stately.ai/docs/studio-pro-plan#pro-features)! However, in order for you to create your own teams you need to enter your payment information on the Billing page and [upgrade to your own Pro subscription](https://stately.ai/docs/upgrade).
