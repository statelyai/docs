...
If you are a team member of another user’s [team](teams.mdx), with the role of [Admin](teams.mdx#admin-role) or [Editor](teams.mdx#editor-role), you also have access to [premium features](#pro-features)! However, if you want to create your own teams, you need to [upgrade to your own Team subscription](upgrade.mdx).
