...
<ThemedImage
  ...
  sources={{
    light: useBaseUrl('/actions-and-actors/entry-and-exit-actions/entry-and-exit-actions.png'),
    dark: useBaseUrl('/actions-and-actors/entry-and-exit-actions/entry-and-exit-actions-dm.png'),
  }}
/>
</p>
...
Find out [more about actions in XState](/xstate/actions/actions) in the XState section of the docs.
