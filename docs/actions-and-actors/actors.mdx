...
<ThemedImage
  ...
  sources={{
    light: useBaseUrl('/transitions-and-events/state-done-events/state-done-events.png'),
    dark: useBaseUrl('/transitions-and-events/state-done-events/state-done-events-dm.png'),
  }}
/>
</p>
