...
2. Choose the circular color swatch in the center of the context menu to open the **Color state** or **Color event** options.
...
Preview the color options in the machine below.

[TODO: embed colors feature machine: (export to prod first) https://registry-fw0lr6tv3-statelyai.vercel.app/registry/editor/f1229924-034d-4432-91e3-25d3d4c958ed?machineId=1a4ddc27-637d-493d-91ea-5e3a95d141ec]
