...
You can embed Figma frames in your states to keep your design and code sources of truth in sync. Embedded Figma frames will stay up to date with the latest changes in your Figma files. Figma frames are a special type of [asset](assets.mdx).
