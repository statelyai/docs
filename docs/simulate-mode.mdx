...
[Eventless (always) events](/editor-states-and-transitions/#eventless-always-events) will be triggered instantly upon entering their source state unless they’re guarded with a condition.

### Simulate delayed (after) events

[Delayed (after) events](/editor-states-and-transitions/#delayed-after-events) will be taken automatically after completing the timer.
