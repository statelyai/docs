...
Importing from code is helpful if you’ve already built machines while working with [XState](/xstate/intro), or have created a machine using our older [Stately Viz](https://stately.ai/viz) but haven’t yet tried the Stately visual editor.
