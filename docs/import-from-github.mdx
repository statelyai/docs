...
1. [Import all machines from a GitHub repository](/import-from-github#import-all-machines-from-a-github-repository).
2. [Import machines from a GitHub URL.](/docs/import-from-github#import-machine-from-a-github-url)

:::studio

Import from GitHub is a [Pro feature](/studio-pro-plan) of the Stately Studio.
...
Importing from a GitHub URL works with files in any branch in your repository, as well as files in pull requests.
