...
The order of action execution for a transition is:
...
This follows the [SCXML algorithm](https://www.w3.org/TR/scxml/#microstepProcedure) for microstep execution.
