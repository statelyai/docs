...
2. Create a new state inside your machine or existing state:
    1. Use the **+ State** button that appears above the selected state, or:
...
If a state already contains child states, you can double-click inside the state to create another child state.
...
1. Select the parent state or parent machine.
    1. Using the **quick actions** menu:
        1. Right-click the state to bring up the **quick actions** menu.
        2. Choose **Mark as initial state** from the **quick actions** menu.
    2. Using the **State details** panel:
        1. Open the **State details** panel from the right tool menu.
        2. Choose the new initial state from the **initial state** dropdown menu.
...
1. Select the transition or event you want to change.
    1. Using the **Transition details** panel:
    ...
    2. Dragging the transition handles:
        1. Select the transition or event you want to change.
...
1. Using the **State details** panel:
...
1. Select the first state you want to set as a parallel state
    1. Using the **quick actions** menu:
        1. Right-click the state to bring up the **quick actions** menu.
...
2. Other child states that share the same parent state will be automatically set as parallel states.
...
1. Select the state you want to set as the history state.
    1. Using the **quick actions** menu:
        1. Right-click the state to bring up the **quick actions** menu.
...
1. Select the event to which you want to add a guard.
    1. Using the **+ Transition** button:
    ...
    2. Using the **quick actions** menu:
    ...
    3. Using the **Transition details** panel:
...
2. Use the **+ Transition** button to create more guards on the same transition.
...
1. Select the event you want to replace with an eventless transition.
    1. Using the **quick actions** menu:
        1. Right-click the state to bring up the **quick actions** menu.
        2. Choose **Always** from the **Event type** options.
    2. Using the **Transition details** panel:
        1. Open the **Transition details** panel from the right tool menu.
...
4. Select the newly-created event.
    1. Using the **quick actions** menu:
        1. Right-click the state to bring up the **quick actions** menu.
...
1. Using the **quick actions** menu:
    ...
    3. Dragging the transition arrow:
        1. Select the event.
...
2. Drag from the handles on the left, right and bottom sides of the selected state, and release to create a connecting transition, event and new state.
    1. The newly-created event will automatically be created as an invoke done event.
    2. You can also change an existing event into an invoked done event using the **quick actions** menu:
...
2. Drag from the handles on the left, right and bottom sides of the selected state, and release to create a connecting transition, event and new state.
    1. The newly-created event will automatically be created as an invoke done event.
    2. When an invoke done event already exists from that state, creating another event will automatically create that event as an invoke error event.
    3. You can also change an existing event into an invoked error event using the **quick actions** menu:
