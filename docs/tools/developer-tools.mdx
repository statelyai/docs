...
[Read about TypeScript typegen on our blog](https://stately.ai/blog/introducing-typescript-typegen-for-xstate) and [how to nest XState typegen files](https://stately.ai/blog/nesting-xstate-typegen-files).
