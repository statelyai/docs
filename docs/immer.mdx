...
XState already allows you to immutably update `context` partially or completely in [assign actions](./actions.mdx#assign). However, for more complex scenarios, you may want to use Immer to update `context` in a less verbose way.
