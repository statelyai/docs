...
Typegen might incorrectly annotate actions, services, guards and delays if they are called “in response” to [eventless “always” transitions](/transitions-and-choices/always) or raised events. We are working on fixing this, both in XState and in the typegen.
