...
If the machine is already locked, you can unlock it by clicking on the **Locked** button in the top bar and then confirm that you wish to unlock the machine.
