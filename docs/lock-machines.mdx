...
You can lock a machine anytime to prevent accidental edits. Locked machines have a <Lock size={18} /> **Locked** status displayed in the editor’s top bar. They also have a lock icon in the project’s machine list in the left panel.
...
If the machine is already locked, you can unlock it by clicking on the **Locked** button in the editor’s top bar and then confirm that you wish to unlock the machine.
