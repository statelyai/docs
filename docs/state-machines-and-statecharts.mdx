...
Now you know enough to get started in the [Stately Studio](https://stately.ai/editor). Get an [overview of the Stately Studio and its features](studio.mdx#studio-editor), or [continue to learn more about states in detail](/states/intro.mdx).
