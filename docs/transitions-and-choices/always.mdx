...
Always transitions are checked immediately when the machine enters the state node. They are extremely useful for reducing duplication in guards, along with other uses.
