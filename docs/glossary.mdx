...
A history state returns the machine to the most recently active state. The history state is represented by the <img alt='box with an H inside' src='/history-state-icon.png' height='24' width='24' style={{display: 'inline', marginBottom: '-6px'}} /> icon.
