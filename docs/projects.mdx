...
<ThemedImage
  ...
  sources={{
    light: useBaseUrl('/projects/my-projects.png'),
    dark: useBaseUrl('/projects/my-projects-dm.png'),
  }}
/>
</p>
...
You can move projects between your teams if you have an [**Owner**](teams#owner-role) role on both teams.
