...
You can move a machine to a different team or to your personal projects from the <MoreHorizontal size={18} /> triple dot contextual menu alongside the machine’s name in the machines list.