...
One way to implement event sourcing is to persist the events as they happen using the [inspection API](inspection.mdx), and then replay them to restore the state of the actor:
