...
<<<<<<< HEAD
We’ll revisit services in more depth later. [Take a fast track to learn more about services](/services/intro).
=======
We’ll revisit actors in more depth later. [Take a fast track to learn more about actors](/path-to/actors).
>>>>>>> mellson/docusaurus-2-2

### Delays

Delays are used in XState to represent timers and intervals. We’ll revisit delays in more depth later. [Take a fast track to learn more about delays](/transitions-and-choices/after).
