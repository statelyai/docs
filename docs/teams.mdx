...
Teams and shared projects are Pro features of the Stately Studio. [Check out the features on our Pro plan](/studio-pro-plan.mdx) or [upgrade to try the Pro plan with a 30-day free trial](https://stately.ai/registry/billing).
...
- Create, restore, and delete versions of team project machines
...
- Create team projects
- Edit, fork, and view team projects and machines
- Create, restore, and delete versions for team project machines
...
- Create a new version for team project machines

:::studio

### Features for team members

All team members will be granted [Pro features](/studio-pro-plan.mdx#pro-features) except for being able to create their own teams. [Find out more information about the Pro plan](/studio-pro-plan.mdx).
