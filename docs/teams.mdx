...
Teams and shared projects are [Pro features](/studio-pro-plan) of the Stately Studio.
...
All team members will be granted [Pro features](https://stately.ai/docs/studio-pro-plan#pro-features) with the exception of being able to create their own teams. See more details in the [Pro plan](https://stately.ai/docs/studio-pro-plan).
