...
Last updated August 2023, adding [Generating flows](#generating-flows) as we now use OpenAI for the generate flow feature.
...
We use OpenAI for generating flows. Generating flows is an optional Pro feature and we do not send any of your personal data to OpenAI. We only send your machine configurations back to OpenAI if you are modifying an existing flow.
