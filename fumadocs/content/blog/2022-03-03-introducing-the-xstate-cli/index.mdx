...
Around a month ago, we released [TypeScript Typegen](../../docs/assets/blog/2022-01-27-introducing-typegen/index.mdx) - an enormous upgrade to the TypeScript experience for XState.
