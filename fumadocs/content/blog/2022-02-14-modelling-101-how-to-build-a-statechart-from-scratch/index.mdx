...
The first group is for services, tasks where you need to _do something when they finish_. I wrote a [longer guide about the distinction between actions and services here](../../docs/assets/blog/2021-04-30-should-this-be-an-action-or-a-service/index.mdx).
