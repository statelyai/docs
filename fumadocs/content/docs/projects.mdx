...
![Stately Studio My Projects page showing three pages of projects along with each project’s name, number of machines, and whether the project is public, private, or unlisted.](./assets/projects/my-projects.png)
...
![Stately Studio’s editor showing the Machines list in the left drawer for Stately Studio Tutorials project. The selected machine is called ‘Parent states.’](./assets/projects/machines-list.png)
