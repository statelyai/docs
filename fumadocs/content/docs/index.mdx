...
[Stately.ai](studio.mdx) is a visual software modeling platform for modeling your app & business logic as state machines/statecharts and actors, and scales to any level of complexity.
...
<Cards>
  <Card
    href="/docs/states"
    title={<><RocketIcon size="20" className="mr-2" /> Get started</>}
  >
  ...
  <Card
    href="/docs/studio"
    title={<><LayoutIcon size="20" className="mr-2" /> Stately Studio overview</>}
  >
  ...
  <Card
    ...
    title={<><BookOpenTextIcon size="20" className="mr-2" /> Learn state machines and statecharts</>}
  >
    With our no-code introduction.
  </Card>
  <Card
    href="/docs/xstate"
    title={<><CodeIcon size="20" className="mr-2" /> Learn XState</>}
  >
...
![The Stately team including Gavin, Farzad, David, Mateusz, Jenny, Laura, Anders, Nick, and Kevin, all standing in front of garage doors, laughing and smiling at each other.](./assets/stately.png)
