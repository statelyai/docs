...
![Canvas tools in Stately Studio, including a sparkles AI icon, pointer icon, hand icon, and plus icon which is focused and has an open menu for adding a state or a note.](./assets/canvas-view-controls/canvas-tools.png)
...
![Starter machine in Stately Studio. The only panel visible is the top left corner with the Stately logo and the machine name.](./assets/canvas-view-controls/hide-ui.png)
...
![Starter machine in Stately Studio. All the panels are visible, including the top bar, view options, left sidebar, and right tool menu.](./assets/canvas-view-controls/show-ui.png)
