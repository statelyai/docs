...
![A GIF of the Studio's deploy modal, with the 'Create API Key' button highlighted.](./assets/generate-project-token-light.gif)
...
![A GIF of the Studio's settings page, with the 'Create API Key' button highlighted.](./assets/generate-account-token-light.gif)
...
![A GIF of the Studio's OpenAPI documentation, with the 'Authorize' button highlighted.](./assets/swagger-auth.gif)
