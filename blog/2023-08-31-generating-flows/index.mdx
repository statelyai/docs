...
_The following machine is the result of generating the flow described by “A simple checkout process.”_
...
_The following machine is the result of modifying the previous flow with the description “Add a new state to the flow that handles a user cancelling their order.”_

<EmbedMachine
  name="checkout, modified"
  embedURL="https://stately.ai/registry/editor/embed/8f7e6dc9-0ec0-425d-a20c-fef3849ee264?machineId=d3b4da3d-f9ee-46ef-b85e-736af1dac843"
/>
