...
image: /blog/2023-12-07-tidefi-and-stately-case-study/logo-with-name.svg
---
...
a. nesting actors underneath a root actor
b. broadcasting an INIT event to register actors and facilitate storing references
c. handle some communication via broadcasts, and others as direct events or data queries
