...
The first step will be to [install XState v5](/docs/xstate#installation). If you’re using a framework or library like [React](/docs/xstate-react), [Vue](/docs/xstate-vue), or [Svelte](/docs/xstate-svelte), you should also install the XState v5 compatible dependencies.
