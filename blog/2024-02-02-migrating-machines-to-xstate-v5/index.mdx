...
In this case, the provider is passed a `logic` prop whose value is the machine with the provided implementations. This is useful if you want to provide different implementations to different instances of the same machine.
