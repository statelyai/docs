...
<p>
  <ThemedImage
    ...
    sources={{
      light:
        '/blog/2024-01-23-state-machines-whats-in-a-name/orthogonality.png',
      dark: '/blog/2024-01-23-state-machines-whats-in-a-name/orthogonality.png',
    }}
  />
</p>
...
<p>
  <ThemedImage
    ...
    sources={{
      light:
        '/blog/2024-01-23-state-machines-whats-in-a-name/watch-batteries.png',
      dark: '/blog/2024-01-23-state-machines-whats-in-a-name/watch-batteries.png',
    }}
  />
</p>
...
<p>
  <ThemedImage
    ...
    sources={{
      light: '/blog/2024-01-23-state-machines-whats-in-a-name/horrocks-cd.png',
      dark: '/blog/2024-01-23-state-machines-whats-in-a-name/horrocks-cd.png',
    }}
  />
</p>
...
<p>
  ...
  >
    <ThemedImage
      ...
      sources={{
        light:
          '/blog/2024-01-23-state-machines-whats-in-a-name/cd-player-studio.png',
        dark: '/blog/2024-01-23-state-machines-whats-in-a-name/cd-player-studio-dm.png',
      }}
    />
  </a>
</p>
