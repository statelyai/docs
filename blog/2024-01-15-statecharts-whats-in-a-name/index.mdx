...
<p>
  ...
  >
    <ThemedImage
      alt="a state machine for part of the CD player example showing states for when the CD is loaded and the CD is stopped, playing, and paused."
      sources={{
        light:
