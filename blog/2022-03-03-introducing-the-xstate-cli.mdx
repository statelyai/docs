...
Around a month ago, we released [TypeScript Typegen](./introducing-typescript-typegen-for-xstate) - an enormous upgrade to the TypeScript experience for XState.
