---
title: 'Introducking Stately Sky'
...
## Why Sky: a seamless developer experience without the lock-in(Working title)

### Developer Experience

We know that state machines are extremely powerful for defining app logic, and Sky supercharges the Studio by allowing developers to ***build and deploy*** workflows to the edge, all defined as state machines! Typically, when we think of building workflows or long running processes, we typically think of 2 possible paths: 
...
The snippet above is all that’s needed in code to connect an application to the live running actor in Stately Sky. For details on all the configuration steps, check out the “[Getting Started](https://stately.ai/docs/stately-sky-getting-started)” guide that walks through the full setup.
...
Our very own Laura Kalbag whipped up an interactive collaborative sleep demo built with Sky.[ Check it out here](https://laurakalbag.github.io/collaborative-sleep-sky/), and be sure to open multiple tabs to simulate different users! 

### Resources

- [Getting Started](https://stately.ai/docs/stately-sky-getting-started)
- [Office Hours demo](https://youtu.be/_iTjIWq6M1g)
- [Quickstart video demo](https://youtu.be/A_J1jbz1oWw)