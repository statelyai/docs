...
tags: [actor model, modeling, statechart, tutorials, state machine, typescript, blog]
authors: [gavin]
...
For more detailed examples around working with actors in XState, like callback or promised-based actor spawning, sending updates, and communicating between actors, [check out our guides:](https://xstate.js.org/docs/guides/actors.html).
