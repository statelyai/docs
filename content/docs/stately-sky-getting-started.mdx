...
![Stately Sky modal showing no API key created yet. There is a button to Create API Key.](./assets/sky-getting-started/editor-no-api-key.png)

3. Be sure to copy that API key and save it somewhere safe. You’ll need it later.

The page should look like this:

![Stately Sky modal shows the API key in an input hidden behind password dots. There are options to Regenerate, Delete, Reveal, or copy the API key to the clipboard.](./assets/sky-getting-started/editor-api-key.png)
...
![Stately Sky modal shows the Traffic light workflow listed under Existing deploys. The workflow has its own URL with the options to Copy URL or delete alongside.](./assets/sky-getting-started/editor-deployed-workflow.png)
...
![package.json](./assets/sky-getting-started/code-sky-cmd.png)
