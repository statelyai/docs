...
<Tabs groupId="xstate-version" items={['v5', 'v4']} persist>
...
<Tab value="v5-context" label="XState v5 (context)">
...
<Tabs items={['v5', 'v4 arguments', 'v4 function']}>
<Tab value="v5" label="XState v5">
