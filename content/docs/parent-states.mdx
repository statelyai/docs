...
The [initial state](initial-states) of a parent state is the state that is entered when the parent state is entered. Parent states _must_ have an initial states.
