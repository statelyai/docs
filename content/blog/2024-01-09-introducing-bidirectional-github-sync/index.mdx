...
![Connect a project to a GitHub repository by clicking the Connect GitHub button.](/blog/2024-01-09-introducing-bidirectional-github-sync/connect-github-button.png)
...
![Importing allows users to choose a repository, a branch, and to select individual files or entire folders to sync with Stately Studio.](/blog/2024-01-09-introducing-bidirectional-github-sync/github-select-files.png)
...
![Stately Studio has offers powerful free and premium features for working with your state machines after importing them from a GitHub repository, like using Version History.](/blog/2024-01-09-introducing-bidirectional-github-sync/premium-feature-version-history.png)
...
![By default, connected repos are auto-synced with the GitHub repo but this can be disabled if you want to manually sync instead.](/blog/2024-01-09-introducing-bidirectional-github-sync/github-auto-sync.png)
...
![Connected projects have a GitHub Settings panel where users can create new pull requests targeting any branch in the connected repository.](/blog/2024-01-09-introducing-bidirectional-github-sync/github-settings.png)
...
![Pull requests appear on GitHub just as they normally would and can be reviewed, modified, approved, and merged.](/blog/2024-01-09-introducing-bidirectional-github-sync/github-pull-request.png)
