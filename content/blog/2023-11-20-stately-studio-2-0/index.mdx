...
![Split view with state machine for a sensor reading app on the left, and a generated UI for the sensor readings on the right. The generated UI has a title, the current sensor readings, and buttons to log new readings. On top of the split view is a Generate React app button.](../../docs/assets/blog/2023-11-20-stately-studio-2-0/generate.png)
...
![State machine for a color picker where an image of an expanded color picker is being dragged into the open state.](../../docs/assets/blog/2023-11-20-stately-studio-2-0/sky.png)
