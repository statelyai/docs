...
![The Stately Inspector view, showing a state machine for the pizza ordering process. The current state and available event is highlighted in green.](/blog/2024-01-15-introducing-stately-inspector/inspector.png)
...
![The Stately Inspector view, showing a state machine and a sequence diagram for the pizza ordering process side-by-side.](/blog/2024-01-15-introducing-stately-inspector/machine-and-sequence-diagram.png)
