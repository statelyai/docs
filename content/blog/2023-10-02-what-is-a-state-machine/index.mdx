...
![A state machine for a music player. The state machine starts in the Paused state, and on play, goes to the Playing state. On pause, it goes back to the Paused state. In any state, you can skip to the next track.](../../docs/assets/blog/2023-10-02-what-is-a-state-machine/music-player-state-machine-light.png)
...
![A booking state machine with an initial idle state. From idle you can transition to car booking, flight booking, and hotel booking states.](../../docs/assets/blog/2023-10-02-what-is-a-state-machine/flight-booking-state-machine.png)
...
![Pending and shipped states.](../../docs/assets/blog/2023-10-02-what-is-a-state-machine/order-states-light.png)
...
![There is an initial Pending state. The machine transitions from Pending to the Shipped state with the item shipped event.(../docs/assets/blog/2023-10-02-what-is-a-state-machine/order-event-light.png)
...
![State machine for an order: the states are pending, shipped, delivered, and returned.(../docs/assets/blog/2023-10-02-what-is-a-state-machine/order-transitions-light.png)
...
![A mermaid diagram of our order state machine.(../docs/assets/blog/2023-10-02-what-is-a-state-machine/mermaid-order-machine-light.png)
