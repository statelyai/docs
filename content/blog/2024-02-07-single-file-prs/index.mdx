...
This time last year, [we introduced importing a single file into the Stately Studio from GitHub](2023-02-06-github-import-machines). Now, we’re taking it a step further. As part of our [bi-directional GitHub integration](2024-01-09-introducing-bidirectional-github-sync), you can import a state machine (or multiple state machines!) from a single file in GitHub, make changes in Stately Studio, and make a pull request back to GitHub without touching any code. You can do it all in the browser; no code editor required.
