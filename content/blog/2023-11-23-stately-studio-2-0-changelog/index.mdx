...
This week has seen us introduce some of our biggest features yet and plenty of small updates to improve your Stately experience. Do you want to learn more about our vision for this release? Find out more in [David’s latest blog post on Stately Studio 2.0](../../docs/assets/blog/2023-11-20-stately-studio-2-0).

{/* truncate */}

## Stately Sky

Stately Sky is our new serverless platform for running workflows within the Studio. With Sky, you can now run your statecharts as live machines in minutes, complete with XState v5 actors and multiplayer support. Deploy your state machine as a workflow from the Deploy button in the editor’s top bar. [Read more about Stately Sky in Gavin’s blog post](../../docs/assets/blog/2023-11-13-introducing-stately-sky).
