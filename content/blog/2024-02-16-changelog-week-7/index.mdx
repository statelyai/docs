...
![The machines list panel showing a list of machines ordered alphabetically, the sort button is pressed and a menu is showing the options for Name A-Z, Name Z-A, Last updated and first updated. The Name A-Z option is selected.](/blog/2024-02-16-changelog/sort.png)
