---
title: Embed machines
---

import EmbedMachine from '@site/src/components/EmbedMachine';

You can embed your machines anywhere that supports [`<iframe>`](https://developer.mozilla.org/en-US/docs/Web/HTML/Element/iframe). We love to use embedded machines in our docs! Below is an example of an embedded machine:
...
If you want us to prioritize improving embed mode, please [upvote it on our feedback page](https://feedback.stately.ai/editor/p/improve-embed-mode).
