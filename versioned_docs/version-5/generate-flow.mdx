...
We only send your prompt text to OpenAI when you generate an all-new flow.
...
When you use **Generate from current flow**, we send your machine definition to OpenAI to help build the response from the current flow.
