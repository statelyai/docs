...
Here you can find all the documentation for the Stately Studio and [XState](./xstate.mdx). There are a few ways you might want to get started:
...
The Stately Studio is powered by [XState](./installation.mdx), a best-in-class open source library for handling complexity at scale.
