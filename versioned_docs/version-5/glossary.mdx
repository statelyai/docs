...
[Context](context.mdx) is how you store data in a state machine actor. `context` is a special property available in all states and used to store data relevant to the state machine.
