...
An **event** is a signal, trigger, or message that causes a transition. 
...
You can add `.description` to transitions to describe their purpose and share related notes with your team. Stately Studio’s editor renders these descriptions in the machine and supports markdown, including links, images, and lists. [Read more about descriptions in Stately Studio](descriptions.mdx).
