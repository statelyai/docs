...
![Image showing the Stately Studio with the export from code panel highlighted.](/export_from_code_panel.jpg)
...
![Image showing the Stately Studio with the export code modal open.](/export_from_top_bar.jpg)
...
![Image showing the Stately Studio with the export code item highlighted in the machine list.](/export_from_machine_list.jpg)
