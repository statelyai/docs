...
1. Open the <Code size={16} /> **Code** panel from the right tool menu.
...
1. Open the export **Code** modal using the <Upload size={16} /> export icon in the header.
...
1. Open the machine menu by clicking the <MoreHorizontal size={16} /> ellipsis button to the right of the machine name.
2. Click the <ShareIcon size={16} /> **Export code** button in the menu to open the **Export machine** dialog.
