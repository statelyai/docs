...
State machines always start at an [initial state](TODO), and may end at a [final state](TODO). The state machine is always in a finite state.
...
Read more about [transitions](TODO).
...
See [identifying states](TODO) for more information.
...
Read more about [final states](TODO).
