...
You can automatically generate intelligent typings for XState with our VS Code extension and [command line interface](developer-tools#xstate-cli-command-line-interface). [Read more about how to use typegen, and our recommended best practices, on the Typegen page](#).
