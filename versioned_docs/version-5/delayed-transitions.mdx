...
1. Right-click the event to bring up the edit menu.
...
Your delay time interval will be displayed in a human-readable format on the canvas. For example, 15000ms will be displayed as 15 seconds.
