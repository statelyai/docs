...
<p>
  <ThemedImage
    ...
    sources={{
      light: '/live-sim/live-sim-side-by-side.png',
      dark: '/live-sim/live-sim-side-by-side.png',
    }}
  />
</p>
...
<p>
  <ThemedImage
    ...
    sources={{
      light: '/live-sim/live-sim-menu.png',
      dark: '/live-sim/live-sim-menu-dm.png',
    }}
  />
</p>
...
<p>
  <ThemedImage
    ...
    sources={{
      light: '/live-sim/live-sim-start.png',
      dark: '/live-sim/live-sim-start-dm.png',
    }}
  />
</p>
...
<p>
  <ThemedImage
    ...
    sources={{
      light: '/live-sim/live-sim-join.png',
      dark: '/live-sim/live-sim-join-dm.png',
    }}
  />
</p>
