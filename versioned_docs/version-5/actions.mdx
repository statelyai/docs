...
First, select the state you want to have an entry action.

### On the canvas

1. Select the state where you want to add an entry action.
2. Use the <Plus size={18} /> plus icon button to open the edit menu.
3. Choose **Entry action** from the menu to add an entry action block to the event.
...
2. Use the **+ Effect** button to open the effects menu, and choose **Add entry action**.
3. Write your action’s name in the action’s text input.

### Add an exit action to a state

First, select the state you want to have an exit action.

### On the canvas

1. Select the state where you want to add an exit action.
2. Use the <Plus size={18} /> plus icon button to open the edit menu.
3. Choose **Exit action** from the menu to add an exit action block to the event.
4. Write your action’s name in the exit action’s text input.

### Using the event details panel

1. Open the state <Info size={18} /> **Details** panel from the right tool menu.
2. Use the **+ Effect** button to open the effects menu, and choose **Add exit action**.
3. Write your action’s name in the action’s text input.

### Add a custom action

You can add the following custom actions
