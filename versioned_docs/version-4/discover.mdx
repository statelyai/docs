...
2. Choose **Export code** from the <MoreHorizontal size={18} /> triple dot contextual menu alongside the machine name to open the Export machine dialog.
...
1. Open the left drawer menu to show the **Machines** list.
2. Choose **Fork machine** from the <MoreHorizontal size={18} /> triple dot contextual menu alongside the machine name to open the Form machine dialog.
...
1. Choose **Fork machine** from the <MoreHorizontal size={18} /> triple dot contextual menu alongside the machine name to open the Form machine dialog.
