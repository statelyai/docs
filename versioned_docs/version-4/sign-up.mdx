...
We offer a **7-day free trial** on the [Stately Studio Pro](studio-pro-plan.mdx), [Stately Studio Team](studio-team-plan.mdx), and [Stately Studio Enterprise](studio-enterprise-plan.mdx) so you can explore how our suite of paid features work for you and your team. You can [upgrade](upgrade.mdx) when you’re signed into the Stately Studio.
