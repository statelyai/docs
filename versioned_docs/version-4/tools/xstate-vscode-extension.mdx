...
You can automatically generate intelligent typings for XState with our VS Code extension and [command line interface](/tools/developer-tools.mdx#xstate-cli-command-line-interface). [Read more about how to use typegen, and our recommended best practices, on the Typegen page](/docs/xstate-v4/xstate/typescript/typegen).
