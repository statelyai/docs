...
If you are a team member of another user’s [team](teams.mdx), with the role of [Admin](/docs/teams/#admin-role) or [Editor](t/docs/teams/#editor-role), you also have access to [premium features](/docs/studio-pro-plan.mdx)! However, if you want to create your own teams, you need to [upgrade to your own Pro or Team subscription](upgrade.mdx).
