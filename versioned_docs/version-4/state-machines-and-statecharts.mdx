...
The rounded rectangle boxes are states. [Read how to create states in the Stately Studio](/states/intro.mdx).
...
The filled circle with an arrow icon represents the initial state. [Read how to create initial states in the Stately Studio](/states/initial-states.mdx).
...
Now you know enough to get started in the [Stately Studio](https://stately.ai/editor). Get an [overview of the Stately Studio and its features](studio.mdx#stately-studios-editor), or [continue to learn more about states in detail](/states/intro.mdx).

:::xstate

## XState basics

Are you looking for the XState basics? In XState, the concepts are the same, but you might be looking for the code. [Read the XState basics section](/xstate/basics/what-is-a-statechart.mdx).
