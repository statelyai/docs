...
Generate React app generates code for use with [XState V5](/docs/xstate). [Read about how to migrate from XState V4 to V5](/docs/migration).
...
You have limited number of generations available to use each month. The number of available generations is reset at the beginning of each calendar month.
