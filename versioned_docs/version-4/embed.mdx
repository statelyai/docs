...
You can also [get your machine as an image](/docs/image) for platforms where `<iframe>` is not supported.
...
The embed URL has some of the same parameters as the [machine URL](/docs/url).
