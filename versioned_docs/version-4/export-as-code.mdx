...
- Markdown (*beta*) for use in documentation ([available on premium plans](studio-pro-plan.mdx))
- Stories (*beta*) for use in requirements and documentation ([available on premium plans](studio-pro-plan.mdx))
