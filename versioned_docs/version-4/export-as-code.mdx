...
Exporting as code is useful if you want to use your machine with [XState](/docs/xstate) inside your codebase or if you want to duplicate your machine without using **Fork**.

:::new

You can now [generate a React app from your machine](generate-react.mdx).
...
- Markdown (_beta_) for use in documentation ([available on premium plans](studio-pro-plan.mdx))
- Stories (_beta_) for use in requirements and documentation ([available on premium plans](studio-pro-plan.mdx))
