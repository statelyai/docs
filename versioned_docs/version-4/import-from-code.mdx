...
Importing from code is helpful if you’ve already built machines while working with [XState](/xstate/intro.mdx), or have created a machine using our older [Stately Viz](https://stately.ai/viz) but haven’t yet tried Stately Studio’s editor.
