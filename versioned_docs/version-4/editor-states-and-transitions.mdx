...
**Eventless transitions** are transitions that are *always* taken when the transition is enabled. In Stately’s editor, delayed transitions are labeled “always.” [Read more about eventless transitions](/docs/eventless-transitions).
